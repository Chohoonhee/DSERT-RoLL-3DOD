...
class DataAugmentor(object):
    ...
    def random_world_flip(self, data_dict=None, config=None):
        ...
        gt_boxes, points, points_radar = data_dict['gt_boxes'], data_dict['points'], data_dict['points_radar']
        ...
        for cur_axis in config['ALONG_AXIS_LIST']:
            ...
            if return_noise_flag:
                gt_boxes, points, points_radar, enable_curaxis = getattr(augmentor_utils, 'random_flip_along_%s' % cur_axis)(
                    gt_boxes, points, points_radar, return_enable_xy=True
                )
                enable_xy.append(enable_curaxis)
            else:
                gt_boxes, points, points_radar = getattr(augmentor_utils, 'random_flip_along_%s' % cur_axis)(
                    gt_boxes, points, points_radar
                )
        ...
        data_dict['points_radar'] = points_radar
        return data_dict
    ...
    def random_world_rotation(self, data_dict=None, config=None):
        ...
        if return_noise_flag:
            gt_boxes, points, points_radar, noise_rotation = augmentor_utils.global_rotation(
                data_dict['gt_boxes'],
                data_dict['points'],
                data_dict['points_radar'],
                rot_range=rot_range,
            ...
            gt_boxes, points, points_radar = augmentor_utils.global_rotation(
                data_dict['gt_boxes'], data_dict['points'], data_dict['points_radar'], rot_range=rot_range
            )
    ...
    def random_world_scaling(self, data_dict=None, config=None):
        ...
        if return_noise_flag:
            gt_boxes, points, points_radar, noise_scale = augmentor_utils.global_scaling(
                data_dict['gt_boxes'],
                data_dict['points'],
                data_dict['points_radar'],
            ...
            gt_boxes, points, points_radar = augmentor_utils.global_scaling(
                data_dict['gt_boxes'], data_dict['points'], data_dict['points_radar'], config['WORLD_SCALE_RANGE']
            )
    ...
    def random_world_translation(self, data_dict=None, config=None):
        ...
        if return_noise_flag:
            gt_boxes, points, points_radar, noise_trans_mat_T = augmentor_utils.global_translation(
                data_dict['gt_boxes'],
                data_dict['points'],
                data_dict['points_radar'],
                config['STD'],
            ...
            gt_boxes, points, points_radar = augmentor_utils.global_translation(
                data_dict['gt_boxes'], data_dict['points'], data_dict['points_radar'], config['STD']
            )
    ...
    def random_image_pc_flip(self, data_dict=None, config=None):
        ...
        points_radar = data_dict["points_radar"]
        calib = data_dict["calib"]
        # optional
