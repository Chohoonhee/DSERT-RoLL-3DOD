...
class MMDETFPN(nn.Module):
    ...
    def forward(self, batch_dict):
        ...
        for layer in single_result.keys():
            ...
            for i, cam in enumerate(self.data):
...
class MMDETFPNTHERMAL(nn.Module):
    def __init__(self, model_cfg):
        super().__init__()
        self.model_cfg = model_cfg
        self.imgconfig = model_cfg.IMGCONFIG
        ...
        # self.img_backbone.patch_embed.proj = nn.Conv2d(1, self.feat_dim_config, kernel_size=(4,4), stride=(4,4))
        self.data = ['camera_1']
        # self.data = ['thermal_camera_0']
